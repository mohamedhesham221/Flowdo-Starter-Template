...
return array (
  ...
  'unsentInvoiceInfo' => 'The Invoice cannot be paid until the invoice is approved',
  ...
  'currencyConvertKeyUpdated' => 'Convert Key Updated',
  'unsubscribeSuccess' => 'Unsubscribe Done Successfully',
  ...
  'bestWishes' => 'Best of luck in your job search.',
  //purchase
  'trackInventoryMsg' => 'You can not enable/disable inventory tracking once you\'ve created transactions for this item.',
  'NotFound' => 'Not Found',
  'The_debit_and_credit_amounts_are_not_equal' => 'The debit and credit amounts are not equal',
  'The_entry_must_contain_both_a_credit_and_a_debit' => 'The journal entry must contain both a credit and a debit',
  'JournalEntryAddedSuccessfuly' => 'Journal Entry Added Successfuly',
  'ModificationSuccessfuly' => 'Modification Successfuly',
  'DeleteIsDone' => 'Delete Is Done',
  'mustDeleteChildrenAccounts' => 'You must delete children accounts first',
  'thisAccountHasBalance' => 'This account has balance',
  'MustBeSelectAccount' => 'Must be select account',
  'CostCenterAddedSuccessfuly' => 'Cost Center Added Successfuly',
  'confirmCreateFinancialYear' => 'Are you sure you closed the previous period?',
  'FinancialYearAddedSuccessfuly' => 'Financial Period Added Successfuly',
  'yes_i_sure' => 'Yes i sure',
  'not_possible_add_on_date_of_closing_fiscal_period' => 'It is not possible to add on the date of this closed fiscal period',
  'not_possible_edit_on_date_of_closing_fiscal_period' => 'It is not possible to amend the date of this closed financial period',
  'not_possible_delete_on_date_of_closing_fiscal_period' => 'Deletion is not possible on the date of this closed financial period',
  'noIncomesFound' => 'Seems like no Incomes exists. Please create the income first',
  'trackInventoryMsg' => 'You can not enable/disable inventory tracking once you have created transactions for this item.',
  ...
  'mustBeSelectInvoice' => 'Must be select a invoice',
  //endpurchase
  'MustDeleteTheSource' => 'Must Delete The Source',
  'thisAccountIsRequired' => 'This Account Is Required',
  'TeamProjectPrefix' => 'The identifier prefix is only applied to departments without a code. For departments with codes, the department code is used as the project identifier prefix.',
);
